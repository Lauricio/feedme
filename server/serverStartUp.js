...
//   var users = [
//       {name:"Matt",email:"matt@tapfuse.io",roles:[]},
//       {name:"Vito",email:"vito@tapfuse.io",roles:[]},
//       {name:"Sa",email:"view@example.com",roles:['cook']},
//       {name:"Pauli",email:"pauli@tapfuse.io",roles:['moderator']},
//       {name:"Su",email:"lauricio@tapfuse.io",roles:['admin']}
//     ];
